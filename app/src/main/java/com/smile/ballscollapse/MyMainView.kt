package com.smile.ballscollapse
...
import com.smile.ballscollapse.BuildConfig
...
import com.smile.ballscollapse.viewmodels.MainViewModel
...
abstract class MyMainView: ComponentActivity(), MainPresentView {
    ...
    fun SaveGameDialog() {
        ...
        if (dialogText.isNotEmpty()) {
            ...
            Composables.DialogWithText(this@MyMainView,
    ...
    fun SaveScoreDialog() {
        ...
        if (dialogTitle.isNotEmpty()) {
            ...
            Composables.DialogWithTextField(this@MyMainView,
