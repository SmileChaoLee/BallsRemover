package com.smile.ballscollapse.viewmodels
...
import com.smile.ballscollapse.SmileApp
import com.smile.ballscollapse.constants.Constants
import com.smile.ballscollapse.models.ColorBallInfo
import com.smile.ballscollapse.models.GameProp
import com.smile.ballscollapse.models.GridData
import com.smile.ballscollapse.models.TopPlayer
import com.smile.ballscollapse.presenters.MainPresenter
...
class MainViewModel: ViewModel() {
    ...
    fun initGame(state: Bundle?) {
        ...
        SmileApp.isShowingLoadingMessage = mGameProp.isShowingLoadingMessage
        SmileApp.isProcessingJob = mGameProp.isProcessingJob
        ...
        if (isNewGame) {    // new game
            ...
            // need to be tested
            if (SmileApp.isShowingLoadingMessage) {
